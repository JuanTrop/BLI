/*
 * Archivo: T_INTRDJIUDIVBY_867.java
 * Fecha: 2021-02-05T03:15:25Z
 *
 ...
 */
package com.cobiscorp.cobis.intrd.services;
 ...
 * T_INTRDJIUDIVBY_867 - ClientesOperaciones 
 *
 */
@Path("/INTRD/CLNTS/T_INTRDJIUDIVBY_867")
@Component
@Service({T_INTRDJIUDIVBY_867.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=INTRD)(task.submodule=CLNTS)(task.id=T_INTRDJIUDIVBY_867)(task.version=1.0.0))")
,@Reference(name="VW_CLIENTESIO_726", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CLIENTESIO_726)(view.version=1.0.0))")
...
public class T_INTRDJIUDIVBY_867 {
