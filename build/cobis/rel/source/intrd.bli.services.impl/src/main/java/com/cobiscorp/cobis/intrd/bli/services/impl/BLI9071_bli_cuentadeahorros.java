...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI9071_bli_cuentadeahorros")
})
public class BLI9071_bli_cuentadeahorros implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI9071_bli_cuentadeahorros.class);
