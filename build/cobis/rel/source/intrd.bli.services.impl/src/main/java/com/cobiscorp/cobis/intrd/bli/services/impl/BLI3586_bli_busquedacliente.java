...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI3586_bli_busquedacliente")
})
public class BLI3586_bli_busquedacliente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI3586_bli_busquedacliente.class);
