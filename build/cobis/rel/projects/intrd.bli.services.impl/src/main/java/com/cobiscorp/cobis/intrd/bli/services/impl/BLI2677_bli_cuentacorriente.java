...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI2677_bli_cuentacorriente")
})
public class BLI2677_bli_cuentacorriente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI2677_bli_cuentacorriente.class);
